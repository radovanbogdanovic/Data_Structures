...
void BinaryMaxHeapInt::UpdateElement(int el, int value)
{
	//TODO: Realizovati metod koji zadati element gomile(max heap) uvećava za zadatu pozitivnu vrednost(voditi računa o efikasnosti ovog metoda – ne koristiti metode za dodavanje i brisanje elementa iz gomile).Ako zadati element ne postoji ne menjati gomilu.Smatrati da su vrednosti u gomili jedinstvene.
}
